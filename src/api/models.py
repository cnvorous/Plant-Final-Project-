...
class Plant(db.Model):
    ...
    most_suitable_location=db.Column(db.String(250), nullable=False)
    temperature=db.Column(db.String(250), nullable=False)
    plant_image=db.Column(db.String(250), nullable=False)
    water_req=db.Column(db.String(250), nullable=False) 
    water_tips=db.Column(db.String(250), nullable=False)
    fertilizer_req=db.Column(db.String(250), nullable=False)
    fertilizer_tips=db.Column(db.String(250), nullable=False)
    poisonous=db.Column(db.String(250), nullable=False)
    plant_details=db.Column(db.String(250), nullable=False)
    plant_care_tips=db.Column(db.String(250), nullable=False)
...
class Favorites(db.Model):
    ...
    list_name=db.Column(db.String(250), nullable=True) #would come from user 
