...
class Plant(db.Model):
    ...
    most_suitable_location=db.Column(db.Text(500), nullable=False)
    temperature=db.Column(db.String(50), nullable=False)
    plant_image=db.Column(db.Text(500), nullable=False)
    water_req=db.Column(db.String(50), nullable=False) 
    water_tips=db.Column(db.Text(700), nullable=False)
    fertilizer_req=db.Column(db.String(100), nullable=False)
    fertilizer_tips=db.Column(db.Text(700), nullable=False)
    poisonous=db.Column(db.Text(700), nullable=False)
    plant_details=db.Column(db.Text(700), nullable=False)
    plant_care_tips=db.Column(db.Text(700), nullable=False)
