    ...
    <div className="dashboard-container">
      <div>
        <h1 className="text-center py-4">
          <strong>Dashboard Profile Page</strong>
        </h1>
      </div>
      <div className="row d-flex flex-row justify-content-between mx-4">
        <div className="col-4">
          <div className="d-flex flex-column text-start">
            ...
            <div className="">
              {/* UserLinkinfo */}
              <Link to="/editprofile">
                <a href="#" className="UpdateUserInfo fs-4">
                  Update User Info
                </a>
              </Link>
              {"   "}
      ...
      <div className="row mt-5 mx-4 fs-3">
        {/* LINKS */}
