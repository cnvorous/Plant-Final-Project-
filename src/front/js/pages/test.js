[ 
   ...
   },
   {
      ...
      "water_req": "medium level during growing season",
   ...
   },
   {
      ...
      "water_req": "High",
      "water_tips": " Be sure to check the soil every few days. Allow the top 1” (2.5cm) of soil to dry out before watering. During the winter, when a miniature rose bush plant is resting, keep the soil barely moist.",
      "fertilizer_req": "Moderate",
   ...
   },
   {
      ...
      "plant_details": "A Spider plant is a member of the asparagus family (Asparagaceae) and is in the same family as the popular asparagus fern. The plant produces grassy-looking, narrow leaves about 8”-10” long and less than 1” wide directly from the center of the plant. When kept root-bound, a spider plant sends out numerous long runners (stems) that produce small, delicate, star- shaped, white flowers",
   ...
   },
   {
      ...
      "water_req": "Low",
      "water_tips": "If the top 2”- 3” of soil in the Strawberry Begonia Plant are still moist, do not water. A Strawberry Begonia Plant needs less water in the fall and winter when it is resting",
      "fertilizer_req": "Low",
